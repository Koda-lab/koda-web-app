...
export default function FavoritesSheet() {
    ...
    return (
        <Sheet onOpenChange={(open) => open && loadFavorites()}>
            ...
            <SheetContent className="z-[100] flex flex-col h-[calc(100%-2rem)] top-4 right-4 rounded-2xl border border-red-500/20 shadow-2xl bg-background/80 backdrop-blur-xl sm:max-w-md overflow-hidden">
